---
title: "Unsuccessful Fund Transfer to Another Bank Account | DBS Singapore"
source_url: "https://www.dbs.com.sg/personal/support/bank-local-unsuccessful-transfer.html"
scraped_date: "2026-04-06 00:05:05"
depth: 2
---
...
Ever experienced an unsuccessful Funds Transfer? Here are some possible reasons and ways you can resolve that. We hope that the information provided might help to resolve your problems.
 ...
 Once you have verified your recipientâs bank account details, simply attempt your transfer again. 
 ...
 You may re\-attempt the transfer, once you have verified that your recipientâs account is active and can be used to receive funds.
 


 Transactions might also fail due to the status of the recipientâs account. You may want to check with your recipient if his/her account is closed by their bank. 
...
- XFERS PTE LTD
 ...
 Refer to the complete list of [participating banks and non\-bank financial institutions (NFIs)](https://www.dbs.com.sg/personal/common-disclaimer.page?url=https://abs.org.sg/consumer-banking/fast&3rdparty=%27ABS%27) and account types for funds transfer.


 You might face an error message if your daily transfer limit has been exceeded. Learn more about [how to change local funds transfer limits](bank-local-funds-transfer-change-funds-transfer-limit.html?pid=sg-dbs-help-support-bank-local-unsuccessful-transfer.html).  
...
- [Transfer Funds to Other Bank's Account](bank-local-funds-transfer-transfer-to-other-bank-accounts.html)
