---
title: "Foreign Currency Cheque Deposit | DBS Singapore"
source_url: "https://www.dbs.com.sg/personal/support/bank-cheque-fc-cheque-fees.html"
scraped_date: "2026-04-05 23:28:40"
depth: 2
---
...
- We encourage customers to [receive funds via telegraphic transfer](bank-receive-funds-from-others.html) as a faster and often cheaper alternative to foreign currency cheques.
...
### More information
 ...
 - **Cheque Details:** For detailed instructions on completing your cheque correctly, please refer to our [Deposit a Cheque](bank-cheque-depositing-cheques.html) guide.
- **USD Cheque Deposit Cut\-off Time:** The cut\-off time for USD cheque deposits is 1 PM, Monday to Friday, at all branches.
- **US Treasury Cheques:** Effective 24 Apr 2025, we will no longer accept these cheques. If deposited, weâll return them to your registered address on file via registered mail.
- **Currencies Accepted:** AED (UAE Dirham), BND (Brunei Dollar), CAD (Canadian Dollar), EUR (Euro), GBP (British Pound), HKD (Hong Kong Dollar), MYR (Malaysian Ringgit), MOP (Macau Pataca), THB (Thai Baht), USD (US Dollar) can be accepted.
...
- [Deposit a Cheque](bank-cheque-depositing-cheques.html)
