---
title: "Receive Funds from Others | DBS Singapore"
source_url: "https://www.dbs.com.sg/personal/support/bank-receive-funds-from-others.html"
scraped_date: "2026-04-06 00:05:07"
depth: 2
---
...
Register for [PayNow](https://www.dbs.com.sg/personal/deposits/pay-with-ease/paynow) and receive funds from others by sharing your registered mobile number, or your NRIC/FIN number. Learn more on how to [apply for Paynow](bank-ssb-paynow-register-profile.html).
...
- **Your Name as per bankâs records:**
- **Account Number:** *Learn more on how to find [your Account Number](bank-account-view-account-number.html)*
- **Bank Code:** 7171
- **Branch Code:** First 3 digits of your account number  
*(e.g. Account no. 123\-4\-567890 â Branch Code: 123\)*
...
*To receive USD remittances into your account promptly, you may also share our [USD agent bank details](https://www.dbs.com.sg/personal/deposits/usd-migration-content.page) with your sender.* 
...
A S$10 Handling Commission Fee (Waived for Treasures Customers) is applicable for each Inward Telegraphic Transfer.
 ...
 You may receive foreign currencies into the following list of multi\-currency accounts:
 - My Account
- Multiplier Account
...
*(e.g. Account no. 123\-4\-567890 â Branch Code: 123\)*
- **Branch Name:** DBS Bank Ltd.   
*(You do not need to indicate your Branch Name as it is no longer a requirement)*- **Name of Beneficiary Bank:** DBS Bank
- **Address of Beneficiary Bank:** 12 Marina Boulevard, DBS Asia Central, Marina Bay Financial Centre Tower 3, Singapore 018982
- **Country:** Singapore
- **SWIFT Address/Code:** DBSSSGSG
...
- **Account Number:** *Learn more on how to find [your Account Number](bank-account-view-account-number.html)*
- **Branch Code:** 081   
*(All POSB accounts have a standard branch code of 081\)*
- **Branch Name:** POSB Bank Ltd.  
*(You do not need to indicate your Branch Name as it is no longer a requirement)*
- **Name of Beneficiary Bank:** DBS Bank
- **Address of Beneficiary Bank:** 12 Marina Boulevard, DBS Asia Central, Marina Bay Financial Centre Tower 3, Singapore 018982
